...
const Help = () => {
  return (
    <div className="bg-[#F5FAFF] px-3 pt-12 pb-5 space-y-3 mx-auto relative rounded-[10px]">
      ...
      <Button
        ...
        content={"Consult Now"}
      />
      <div className="absolute  -top-[5px] left-[110px]  w-14 h-14 bg-white rounded-full flex  justify-center items-center shadow-lg">
